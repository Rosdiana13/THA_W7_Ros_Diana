...
namespace THA_Week7_Ros_Diana
{
    public partial class ship : Form
    {
        ...
        List<Button> buttonlistjam16 = new List<Button>();
        ...
        private void ship_Load(object sender, EventArgs e)
        {
            ...
            movie1.Location = new Point(40, 70);
            movie1.Size = new Size(300, 300);
            movie1.Text = "Shaun the Ship";
            ...
            picture.Image = Image.FromFile("C:\\UC Student\\Semester 2\\Application Development\\THA_W7_Ros_Diana\\THA_W7_Ros_Diana\\Poster\\Shaun the Ship.JPG");
            ...
            {
                int acak = seatrandom.Next(0, 100);
                buttonlistjam16[acak].BackColor = Color.Red;
                buttonlistjam16[acak].Enabled = false;
            }
        ...
        private void reset_Click(object sender, EventArgs e)
        {
            ...
            if (nyoba == 2)
            {
                foreach (Button button in buttonlistjam16)
                {
                    if (button.BackColor == Color.YellowGreen)
                    {
                        button.BackColor = Color.MediumSeaGreen;
        ...
        private void Button2_Click(object sender, EventArgs e)
        {
            ...
            foreach (Button seat in buttonlistjam16)
            {
                panel2.Controls.Add(seat);
            }
            Button button = sender as Button;
        ...
        private void Jam16_Click(object sender, EventArgs e)
        {
            panel2.Controls.Clear();
            pilih = 2;
            nyoba = 2;
