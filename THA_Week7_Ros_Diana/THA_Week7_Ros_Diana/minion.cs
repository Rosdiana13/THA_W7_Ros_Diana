...
{
    public partial class minion : Form
    {
        ...
        int nyoba = 0;
        private Form1 form1;
        public minion(Form1 form1)
        {
            InitializeComponent();
            this.form1 = form1;
        }

        private void minion_Load(object sender, EventArgs e)
        {
            ...
            picture.Image = Image.FromFile("C:\\UC Student\\Semester 2\\Application Development\\THA_W7_Ros_Diana\\THA_W7_Ros_Diana\\Poster\\Minion.JPG");
