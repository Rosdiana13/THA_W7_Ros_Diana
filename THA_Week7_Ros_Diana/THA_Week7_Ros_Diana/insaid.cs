...
{
    public partial class insaid : Form
    {
        Panel panel2 = new Panel();
        List<Button> buttonlistjam13 = new List<Button>();
        ...
        int nyoba = 0;
        private Form1 form1;
        public insaid(Form1 form1)
        {
            InitializeComponent();
            this.form1 = form1;
        }

        private void insaid_Load(object sender, EventArgs e)
        {
            Label movie1 = new Label();
            movie1.AutoSize = true;
            movie1.Location = new Point(70, 70);
            movie1.Size = new Size(300, 300);
            movie1.Text = "Insaid Out";
            ...
            picture.Image = Image.FromFile("C:\\UC Student\\Semester 2\\Application Development\\THA_W7_Ros_Diana\\THA_W7_Ros_Diana\\Poster\\insideout.JPG");
            ...
            {
                int acak = seatrandom.Next(0, 100);
                buttonlistjam13[acak].BackColor = Color.Red;
                buttonlistjam13[acak].Enabled = false;
            }
        }
        private void reset_Click(object sender, EventArgs e)
        {
            if (nyoba == 1)
            {
                foreach (Button button in buttonlistjam13)
                {
        ...
        private void Button1_Click(object sender, EventArgs e)
        {
            ...
            foreach (Button seat in buttonlistjam13)
            {
                panel2.Controls.Add(seat);
            }
            Button button = sender as Button;
        ...
        private void Jam13_Click(object sender, EventArgs e)
        {
            panel2.Controls.Clear();
            pilih = 1;
            nyoba = 1;
